    ...
    return (
      <div className="card card-hover" style={{ overflow: "hidden", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "1.5rem", flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <h3 className="card-title" style={{ color: "var(--foreground-default)", marginBottom: "0.625rem", flex: 1 }}>
            {article.title}
          </h3>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <span style={{ fontSize: "0.8125rem", color: "var(--foreground-muted)" }}>{article.date}</span>
            <Link
  ...
  return (
    <div className="card" style={{ display: "flex", gap: "1rem", padding: "1.25rem", alignItems: "flex-start" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <span className="badge badge-gray" style={{ marginBottom: "0.375rem" }}>
          {article.category}
        </span>
        <h4 style={{ fontSize: "0.9rem", lineHeight: 1.4, color: "var(--foreground-default)", fontWeight: 500, marginBottom: "0.25rem" }}>
          {article.title}
        </h4>
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <Link
            href={`/guide/${article.slug}`}
            style={{ fontSize: "0.8125rem", fontWeight: 500, color: "var(--brand-navy)", textDecoration: "none" }}
          >
            Leggi →
          </Link>
        </div>
