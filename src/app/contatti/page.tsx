...
import { STUDIO_PHONE, STUDIO_EMAIL, STUDIO_ADDRESS } from "@/data/mockData";
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", marginBottom: "2.5rem" }}>
                {[
                  { Icon: Phone, label: "Telefono", value: STUDIO_PHONE, href: `tel:${STUDIO_PHONE}` },
                ...
                <div style={{ display: "flex", gap: "1rem" }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontWeight: 500, color: "var(--foreground-default)", lineHeight: 1.5 }}>{STUDIO_ADDRESS}</p>
                  </div>
                </div>
                <div style={{ display: "flex", gap: "1rem" }}>
                  <div style={{ width: "2.75rem", height: "2.75rem", borderRadius: "50%", backgroundColor: "var(--action-secondary)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              ...
              >
                ...
                <div style={{ textAlign: "center" }}>
                  <p style={{ fontWeight: 500, color: "var(--foreground-default)", fontSize: "0.9rem" }}>Via Montenapoleone 8</p>
                  <p style={{ fontSize: "0.875rem", color: "var(--foreground-muted)" }}>20121 Milano (MI)</p>
                  <a
