...
const consultingAreas = [
  {
    ...
    faq: [{domanda:"Con quale frequenza inviate il riepilogo contabile?",risposta:"Produciamo situazioni contabili periodiche (mensili o trimestrali) in base alle esigenze del cliente. I bilanci d'esercizio vengono redatti entro i termini di legge.",keyword_target:"contabilità e bilancio"},{domanda:"Gestite anche la contabilità dei condomini?",risposta:"Sì, offriamo un servizio specifico di gestione contabile condominiale con rendiconto annuale, piano di riparto e comunicazioni ai condomini.",keyword_target:"contabilità e bilancio"},{domanda:"Usate software di contabilità condivisi con il cliente?",risposta:"Lavoriamo con i principali gestionali (TeamSystem, Zucchetti, Wolters Kluwer). Possiamo integrarci con i sistemi già in uso dal cliente o fornire accesso al nostro.",keyword_target:"contabilità e bilancio"}],
    order: 1,
  },
  {
    ...
    faq: [{"domanda":"Gestite anche il contenzioso tributario?","risposta":"Sì, seguiamo il contenzioso tributario in tutte le fasi: dal contraddittorio in sede di accertamento, al ricorso in Commissione Tributaria Provinciale e Regionale.","keyword_target":"consulenza fiscale"},{"domanda":"Come gestite le comunicazioni anomalie dell'Agenzia delle Entrate?","risposta":"Le comunicazioni di irregolarità (art. 36-bis, 36-ter, 54-bis) vengono verificate tempestivamente e gestite con i rimedi più opportuni (regolarizzazione o risposta motivata).","keyword_target":"consulenza fiscale"}],
    order: 2,
  },
  {
    ...
    faq: [{"domanda":"Quanto tempo ci vuole per costituire una SRL?","risposta":"Con la procedura online (atto notarile digitale) i tempi sono di 5-10 giorni lavorativi. Con l'atto notarile tradizionale si aggiunge il tempo per la firma. Prestiamo assistenza completa nella redazione dello statuto.","keyword_target":"diritto societario"},{"domanda":"Assistete anche nelle operazioni di vendita d'azienda?","risposta":"Sì. Seguiamo le due diligence, la strutturazione fiscale dell'operazione, la redazione delle clausole fiscali nei contratti e gli adempimenti successivi alla closing.","keyword_target":"diritto societario"}],
    order: 3,
  },
  {
    slug: "lavoro-e-paghe",
    ...
    faq: [{"domanda":"Come avviene la trasmissione dei dati per le buste paga?","risposta":"Il cliente trasmette le variabili mensili (presenze, assenze, straordinari, ecc.) tramite un foglio strutturato o direttamente via email. Elaboriamo i cedolini e li inviamo entro il termine concordato.","keyword_target":"lavoro e paghe"},{"domanda":"Assistete anche in caso di ispezioni del lavoro?","risposta":"Sì. Offriamo assistenza completa in caso di accesso ispettivo da parte di INPS, INAIL o Ispettorato Nazionale del Lavoro, inclusa la predisposizione della documentazione e la gestione del contraddittorio.","keyword_target":"lavoro e paghe"}],
    order: 4,
  },
  {
    ...
    faq: [{"domanda":"Quanto dura mediamente un'operazione di fusione?","risposta":"I tempi variano in base alla complessità. Una fusione tra due piccole SRL può richiedere 3-4 mesi. Operazioni più articolate con aspetti cross-border richiedono tempistiche più lunghe.","keyword_target":"operazioni straordinarie"},{"domanda":"Effettuate anche perizie di stima ex art. 2343 c.c.?","risposta":"Sì. I nostri professionisti iscritti al Registro dei Revisori Legali possono predisporre perizie di stima per conferimenti in natura nelle società di capitali.","keyword_target":"operazioni straordinarie"}],
    order: 5,
  },
  {
    ...
    faq: [{"domanda":"Siete in grado di assistere nella disclosure di attività estere non dichiarate?","risposta":"Sì. Attraverso la procedura di voluntary disclosure o il ravvedimento operoso, assistiamo i clienti nella regolarizzazione delle attività e dei redditi esteri non dichiarati, valutando la soluzione più opportuna.","keyword_target":"fiscalità internazionale"},{"domanda":"Collaborate con studi esteri per le tematiche cross-border?","risposta":"Disponiamo di una rete consolidata di corrispondenti qualificati nei principali paesi UE ed extra-UE. Coordiniamo le attività degli advisor esteri garantendo unitarietà di approccio.","keyword_target":"fiscalità internazionale"}],
    order: 6,
  },
];
